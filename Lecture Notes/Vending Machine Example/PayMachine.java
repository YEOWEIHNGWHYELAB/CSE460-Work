...
public class PayMachine
{
	...
	private enum PhaseEnum {IDLE, ADDQUARTER, RETURNCHANGE}
	private PhaseEnum phase = PhaseEnum.IDLE;
	...
	public void insertQuarter()
	{
		if (m_dBalance <= m_dMaximumBalance - 0.25 && m_bOutOfOrder == false)
		{
			if(this.phase == PhaseEnum.IDLE){
				this.phase = PhaseEnum.ADDQUARTER;
		...
		{
			if(this.phase == PhaseEnum.IDLE){
				this.phase = PhaseEnum.RETURNCHANGE;
