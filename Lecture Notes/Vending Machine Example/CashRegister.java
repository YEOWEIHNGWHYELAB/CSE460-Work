...
public class CashRegister
{
	...
	private enum PhaseEnum {IDLE, TAKECHAGNE, TAKEQUARTERS, TAKEDIMES, TAKENICKELS}
	...
	public CoinCount takeOutChange(double dAmount)
	{
		...
		{
			if(this.phase == PhaseEnum.IDLE)
				phase = PhaseEnum.TAKECHAGNE;
			...
			if(this.phase == PhaseEnum.TAKECHAGNE){
				phase = PhaseEnum.TAKEQUARTERS;
			...
			if(this.phase == PhaseEnum.TAKEQUARTERS){
				phase = PhaseEnum.TAKEDIMES;
			...
			if(this.phase == PhaseEnum.TAKEDIMES){
				phase = PhaseEnum.TAKENICKELS;
